...
/* Descriptor flags */
#define IDXD_OP_FLAG_FENCE	0x0001UL
#define IDXD_OP_FLAG_BOF	0x0002UL
#define IDXD_OP_FLAG_CRAV	0x0004UL
#define IDXD_OP_FLAG_RCR	0x0008UL
#define IDXD_OP_FLAG_RCI	0x0010UL
#define IDXD_OP_FLAG_CRSTS	0x0020UL
#define IDXD_OP_FLAG_CR		0x0080UL
#define IDXD_OP_FLAG_CC		0x0100UL
#define IDXD_OP_FLAG_ADDR1_TCS	0x0200UL
#define IDXD_OP_FLAG_ADDR2_TCS	0x0400UL
#define IDXD_OP_FLAG_ADDR3_TCS	0x0800UL
#define IDXD_OP_FLAG_CR_TCS	0x1000UL
#define IDXD_OP_FLAG_STORD	0x2000UL
#define IDXD_OP_FLAG_DRDBK	0x4000UL
#define IDXD_OP_FLAG_DSTS	0x8000UL
